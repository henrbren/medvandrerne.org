...
const TrainingModal = ({ selectedItem, closeModal }) => {

  return (<>
    <View style={styles.tableSection}>
            <Text style={styles.tableSectionTitle}>
            {getActivityName(selectedItem.get('trainingType'))}
            {' '}
            ...
            {localize('main.screens.dogDetail.training.info')}
            </Text>
